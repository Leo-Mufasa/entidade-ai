  ...
  return (
    <main className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <img
        ...
        alt="Pássaros"
        className="absolute bottom-[48%] left-1/2 w-[70vw] max-w-[900px] object-contain z-30 animate-fly pointer-events-none"
      />

      {/* Frase central */}
      <div className="absolute bottom-[55%] md:bottom-[38%] left-1/2 -translate-x-1/2 z-40 px-4">
